        ...
        <div className="flex items-center gap-x-8">
          ...
          <button
            ...
            className={clsx(
              ...
              invert ? "hover:bg-white/10" : "hover:bg-primary-900/10"
            )}
            ...
            <Icon
              className={clsx(
                ...
                invert
                  ...
                  : "fill-primary-900 group-hover:fill-primary-700"
              )}
            />
          </button>
        </div>
...
function NavigationRow({ children }: { children: React.ReactNode }) {
  return (
    <div className="even:mt-px sm:bg-primary-900">
      <Container>
...
function NavigationItem({
  ...
  return (
    <Link
      href={href}
      className="group relative isolate -mx-6 bg-primary-900 px-6 py-10 even:mt-px sm:mx-0 sm:px-0 sm:py-16 sm:odd:pr-16 sm:even:mt-0 sm:even:border-l sm:even:border-primary-700 sm:even:pl-16"
    >
      {children}
    ...
    >
      <header>
        ...
        <motion.div
          ...
          className="relative z-50 overflow-hidden bg-primary-900 pt-2"
      ...
      >
        ...
        >
          <GridPattern
            className="absolute inset-x-0 -top-14 -z-10 h-[1000px] w-full mask-[linear-gradient(to_bottom_left,white_40%,transparent_50%)] fill-neutral-50 stroke-primary-900/5"
            yOffset={-96}
            interactive
          />
